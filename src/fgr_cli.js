...
class FGRCLI {
  ...
  async testLLM() {
    ...
    const testPrompt = 'You are the Federal Reserve Chairman. Explain in 1 sentence why GarryCoin interest rates must remain elevated due to meme market volatility.';
